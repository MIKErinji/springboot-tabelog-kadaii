...
public class FavoriteController {
	...
	public String delete(@PathVariable(name = "favoriteId") Integer id,
			@AuthenticationPrincipal UserDetailsImpl userDetailsImpl,
			RedirectAttributes redirectAttributes,
			Model model,
		...
		Optional<Favorite> optionalFavorite = favoriteService.findFavoriteById(id);
		...
		redirectAttributes.addFlashAttribute("successMessage", "お気に入りか削除しました。");
		return "redirect:" + (referer != null ? referer : "/favorites");
	}
}
